...
description: Researches domain ecosystem before roadmap creation. Produces files in .claude/.gsdt-planning/research/ consumed during roadmap creation. Spawned by /gsdt:new-project or /gsdt:new-milestone orchestrators.
