---
name: gsdt-ui-auditor
description: Retroactive 6-pillar visual audit of implemented frontend code. Produces scored UI-REVIEW.md. Spawned by /gsdt:ui-review orchestrator.
...
<upstream_input>
**UI-SPEC.md** (if exists) — Design contract from `/gsdt:ui-phase`
