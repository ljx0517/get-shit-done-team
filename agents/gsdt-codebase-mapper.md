...
<why_this_matters>
**These documents are consumed by other GSDT commands:**

**`/gsdt:plan-phase`** loads relevant codebase docs when creating implementation plans:
...
**`/gsdt:execute-phase`** references codebase docs to:
