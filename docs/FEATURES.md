...
**Purpose:** Create a clean branch suitable for pull requests by filtering out `.claude/.gsdt-planning/` commits. Reviewers see only code changes, not GSD planning artifacts.
