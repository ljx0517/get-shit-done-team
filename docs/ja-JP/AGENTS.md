...
| **モデル (balanced)** | Sonnet |
| **生成物** | `.gsdt-planning/research/STACK.md`, `FEATURES.md`, `ARCHITECTURE.md`, `PITFALLS.md` |
...
| **モデル (balanced)** | Sonnet |
| **カラー** | Purple |
| **生成物** | `.gsdt-planning/research/SUMMARY.md` |
...
| **モデル (balanced)** | Haiku |
| **カラー** | Cyan |
| **生成物** | `.gsdt-planning/codebase/*.md`（7ドキュメント） |
...
| **モデル (balanced)** | Sonnet |
| **カラー** | Orange |
| **生成物** | `.gsdt-planning/debug/*.md`、ナレッジベースの更新 |
