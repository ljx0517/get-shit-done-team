# マルチプロジェクトワークスペース (`/gsdt:new-workspace`)
...
| `--path` | いいえ | `~/gsdt-workspaces/<name>` | 出力先ディレクトリ |
...
- デフォルトのワークスペースベースディレクトリ (`~/gsdt-workspaces/`)
...
- **`~/gsdt-workspaces/` が存在しない場合** — 「ワークスペースが見つかりません」
...
| コンポーネント | パス |
|-----------|------|
| コマンド: new-workspace | `commands/gsdt/new-workspace.md` |
| コマンド: list-workspaces | `commands/gsdt/list-workspaces.md` |
| コマンド: remove-workspace | `commands/gsdt/remove-workspace.md` |
| ワークフロー: new-workspace | `gsdt/workflows/new-workspace.md` |
| ワークフロー: list-workspaces | `gsdt/workflows/list-workspaces.md` |
| ワークフロー: remove-workspace | `gsdt/workflows/remove-workspace.md` |
| Init 関数 | `gsdt/bin/lib/init.cjs`（`cmdInitNewWorkspace`、`cmdInitListWorkspaces`、`cmdInitRemoveWorkspace` を追加） |
| ルーティング | `gsdt/bin/gsdt-tools.cjs`（init switch にケースを追加） |
