...
**前提条件:** 既存の `.claude/.gsdt-planning/PROJECT.md` がないこと
...
リポジトリのコピーと独立した `.claude/.gsdt-planning/` ディレクトリを持つ分離されたワークスペースを作成します。
...
**生成物:** `WORKSPACE.md`、`.claude/.gsdt-planning/`、リポジトリコピー（worktreeまたはclone）
...
**前提条件:** `.claude/.gsdt-planning/ROADMAP.md` が存在すること
...
**前提条件:** `.claude/.gsdt-planning/ROADMAP.md` が存在し、フェーズにフロントエンド/UI作業があること
...
**前提条件:** `.claude/.gsdt-planning/` ディレクトリが存在すること
**動作:**
...
**生成物:** `.claude/.gsdt-planning/reports/SESSION_REPORT.md`
...
**生成物:** `{phase}-UI-REVIEW.md`、`.claude/.gsdt-planning/ui-reviews/` 内のスクリーンショット
...
**生成物:** `.claude/.gsdt-planning/reports/MILESTONE_SUMMARY-v{version}.md`
...
`.claude/.gsdt-planning/` ディレクトリの整合性を検証します。
...
**前提条件:** `.claude/.gsdt-planning/` ディレクトリが存在すること
**生成物:** `.claude/.gsdt-planning/forensics/report-{timestamp}.md`
...
**生成物:** `.claude/.gsdt-planning/` 配下のワークストリームディレクトリ、ワークストリームごとの状態追跡
...
`.claude/.gsdt-planning/` のコミットをフィルタリングしてクリーンなPRブランチを作成します。
...
**生成物:** `.claude/.gsdt-planning/seeds/SEED-NNN-slug.md`
