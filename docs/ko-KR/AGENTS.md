...
| **모델 (balanced)** | Sonnet |
| **생성물** | `.gsdt-planning/research/STACK.md`, `FEATURES.md`, `ARCHITECTURE.md`, `PITFALLS.md` |
...
| **모델 (balanced)** | Sonnet |
| **색상** | Purple |
| **생성물** | `.gsdt-planning/research/SUMMARY.md` |
...
| **모델 (balanced)** | Haiku |
| **색상** | Cyan |
| **생성물** | `.gsdt-planning/codebase/*.md` (7개 문서) |
...
| **모델 (balanced)** | Sonnet |
| **색상** | Orange |
| **생성물** | `.gsdt-planning/debug/*.md`, 지식 베이스 업데이트 |
