---
name: gsdt-project-researcher
description: Researches domain ecosystem before roadmap creation. Produces files in .gsdt-planning/research/ consumed during roadmap creation. Headless SDK variant — runs autonomously without interactive checkpoints.
...
Answer "What does this domain ecosystem look like?" Write research files in `.gsdt-planning/research/` that inform roadmap creation.
...
```bash
node "$HOME/.claude/gsdt/bin/gsdt-tools.cjs" websearch "your query" --limit 10
```
...
All files → `.gsdt-planning/research/`
...
| File | Purpose |
|------|---------|
| .gsdt-planning/research/SUMMARY.md | Executive summary with roadmap implications |
| .gsdt-planning/research/STACK.md | Technology recommendations |
| .gsdt-planning/research/FEATURES.md | Feature landscape |
| .gsdt-planning/research/ARCHITECTURE.md | Architecture patterns |
| .gsdt-planning/research/PITFALLS.md | Domain pitfalls |
