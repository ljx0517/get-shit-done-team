...
/**
 * Extract the tools list from a gsdt-executor.md agent definition.
...
/**
 * Extract the role instructions from a gsdt-executor.md agent definition.
 ...
 * @param agentDef - Raw content of gsdt-executor.md agent definition (optional)
