  ...
  describe('PhaseOpInfo interface', () => {
    it('accepts a valid phase-op output object', () => {
      const info: PhaseOpInfo = {
        phase_found: true,
        phase_dir: '.gsdt-planning/phases/05-Skill-Scaffolding',
        phase_number: '5',
        ...
        commit_docs: true,
        context_path: '.gsdt-planning/phases/05-Skill-Scaffolding/CONTEXT.md',
        research_path: '.gsdt-planning/phases/05-Skill-Scaffolding/RESEARCH.md',
      };
    ...
    it('matches the documented init phase-op JSON shape', () => {
      ...
      const raw = JSON.parse(JSON.stringify({
        phase_found: true,
        phase_dir: '.gsdt-planning/phases/03-Auth',
        phase_number: '3',
        phase_name: 'Auth',
        phase_slug: 'auth',
        padded_phase: '03',
        ...
        planning_exists: true,
        commit_docs: true,
        context_path: '.gsdt-planning/phases/03-Auth/CONTEXT.md',
        research_path: '.gsdt-planning/phases/03-Auth/RESEARCH.md',
      }));
