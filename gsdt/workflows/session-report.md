<purpose>
Generate a post-session summary document capturing work performed, outcomes achieved, and estimated resource usage. Writes SESSION_REPORT.md to .gsdt-planning/reports/ for human review and stakeholder sharing.
</purpose>
...
Read `.gsdt-planning/STATE.md` to get:
- Current milestone and phase
- Progress percentage
- Active blockers
- Recent decisions

Read `.gsdt-planning/ROADMAP.md` to get milestone name and goals.

Check for existing reports:
```bash
ls -la .gsdt-planning/reports/SESSION_REPORT*.md 2>/dev/null || echo "No previous reports"
```
</step>
...
📄 `.gsdt-planning/reports/[filename].md`
...
- [ ] Report written to .gsdt-planning/reports/
