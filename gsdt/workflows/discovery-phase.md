...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gsdt:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/gsdt/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/gsdt/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/gsdt/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/gsdt/templates/discovery.md
...
Use ~/.claude/gsdt/templates/discovery.md.
...
1. Discuss phase context (/gsdt:discuss-phase [current-phase])
2. Create phase plan (/gsdt:plan-phase [current-phase])
