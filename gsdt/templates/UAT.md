...
Template for `.claude/.gsdt-planning/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /gsdt:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsdt:plan-phase --gaps with root causes
...
**Creation:** When /gsdt:verify-work starts new session
...
- `/gsdt:verify-work {phase}` picks up from first pending/blocked test
