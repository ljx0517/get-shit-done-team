...
> **Note:** Planning methodology is in `agents/gsdt-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.gsdt-planning/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
generates: []               # Files this plan must produce (used for completion verification)
...
<!-- For checkpoint task examples and patterns, see @~/.claude/gsdt/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/gsdt:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@.gsdt-planning/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.gsdt-planning/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
See `~/.claude/gsdt/references/tdd.md` for TDD plan structure.
...
<output>
After completion, create `.gsdt-planning/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.gsdt-planning/PROJECT.md
@.gsdt-planning/ROADMAP.md
@.gsdt-planning/phases/03-features/03-01-SUMMARY.md
@.gsdt-planning/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.gsdt-planning/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `~/.claude/gsdt/templates/user-setup.md` for full schema and examples
...
See `~/.claude/gsdt/workflows/verify-phase.md` for verification logic.
