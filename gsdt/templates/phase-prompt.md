...
Template for `.claude/.gsdt-planning/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
```markdown
<context>
@.claude/.gsdt-planning/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.claude/.gsdt-planning/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
<output>
After completion, create `.claude/.gsdt-planning/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.claude/.gsdt-planning/PROJECT.md
@.claude/.gsdt-planning/ROADMAP.md
@.claude/.gsdt-planning/phases/03-features/03-01-SUMMARY.md
@.claude/.gsdt-planning/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.claude/.gsdt-planning/phases/03-features/03-03-SUMMARY.md`
</output>
```
