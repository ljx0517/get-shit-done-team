...
Template for `.gsdt-planning/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Searchability:** `grep -r "USER-SETUP" .gsdt-planning/` finds all phases with user requirements.
