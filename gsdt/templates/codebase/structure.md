...
**New Slash Command:**
- Primary code: `commands/gsdt/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `gsdt/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `gsdt/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/gsdt/workflows/{name}.md`

**New Reference Document:**
- Implementation: `gsdt/references/{name}.md`
