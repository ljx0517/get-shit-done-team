...
Template for spawning gsdt-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="gsdt-debugger", description="Debug UAT-001")
```
...
<prior_state>
Debug file: @.claude/.gsdt-planning/debug/{slug}.md
</prior_state>
