...
3. `.gsdt-planning/active-workstream` file (shared, last-writer-wins)
...
```bash
# All gsdt-tools commands accept --ws
node gsdt-tools.cjs state json --ws feature-a
node gsdt-tools.cjs find-phase 3 --ws feature-b

# Workstream CRUD
node gsdt-tools.cjs workstream create <name>
