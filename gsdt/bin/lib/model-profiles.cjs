 ...
 *
 * Should be in sync with the profiles table in `gsdt/references/model-profiles.md`. But
...
const MODEL_PROFILES = {
  'gsdt-planner': { quality: 'opus', balanced: 'opus', budget: 'sonnet' },
  'gsdt-roadmapper': { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gsdt-executor': { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gsdt-phase-researcher': { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-project-researcher': { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-research-synthesizer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-debugger': { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'gsdt-codebase-mapper': { quality: 'sonnet', balanced: 'haiku', budget: 'haiku' },
  'gsdt-verifier': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-plan-checker': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-integration-checker': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-nyquist-auditor': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-ui-researcher': { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-ui-checker': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'gsdt-ui-auditor': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
};
const VALID_PROFILES = Object.keys(MODEL_PROFILES['gsdt-planner']);
