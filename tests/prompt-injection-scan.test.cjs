...
const { scanForInjection, INJECTION_PATTERNS } = require('../gsdt/bin/lib/security.cjs');
...
const ALLOWLIST = new Set([
  'gsdt/bin/lib/security.cjs',        // The security module itself
  'hooks/gsdt-prompt-guard.js',                  // The prompt guard hook
