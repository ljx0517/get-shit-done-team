...
<execution_context>
@~/.claude/gsdt/workflows/manager.md
...
Project context, phase list, dependencies, and recommendations are resolved inside the workflow using `gsdt-tools.cjs init manager`. No upfront context loading needed.
</context>

<process>
Execute the manager workflow from @~/.claude/gsdt/workflows/manager.md end-to-end.
