...
Creates: .gsdt-planning/seeds/SEED-NNN-slug.md
Consumed by: /gsdt:new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/gsdt/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/gsdt/workflows/plant-seed.md end-to-end.
</process>
