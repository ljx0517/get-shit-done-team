...
`/gsdt:workstreams [subcommand] [args]`
...
- `/gsdt:new-milestone --ws <name>` to set up the milestone
...
### resume
Set the workstream as active and suggest `/gsdt:resume-work --ws <name>`.

## Step 3: Display Results

Format the JSON output from gsdt-tools into a human-readable display.
